DEVICE_PATH := device/tele2/maxi_lte
VENDOR_PATH := vendor/tele2/maxi_lte
...
#TARGET_KERNEL_SOURCE := kernel/tele2/maxi_lte
#TARGET_KERNEL_CONFIG := maxi_lte_debug_defconfig
