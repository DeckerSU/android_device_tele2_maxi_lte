...
$(call inherit-product-if-exists, vendor/tele2/maxi_lte/maxi_lte-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/tele2/maxi_lte/overlay
...
ifeq ($(TARGET_PREBUILT_KERNEL),)
    LOCAL_KERNEL := device/tele2/maxi_lte/prebuilt/Image.gz-dtb
else
    LOCAL_KERNEL := $(TARGET_PREBUILT_KERNEL)
endif

#TARGET_OTA_ASSERT_DEVICE := maxi_lte

TARGET_PROVIDES_INIT_RC := true

PRODUCT_COPY_FILES += \
    device/tele2/maxi_lte/rootdir/init.rc:root/init.rc \
    device/tele2/maxi_lte/rootdir/init.target.rc:root/init.target.rc \
    device/tele2/maxi_lte/rootdir/init.mt6735.rc:root/init.mt6735.rc \
    device/tele2/maxi_lte/rootdir/init.ssd.rc:root/init.ssd.rc \
    device/tele2/maxi_lte/rootdir/init.xlog.rc:root/init.xlog.rc \
    device/tele2/maxi_lte/rootdir/init.usb.rc:root/init.usb.rc \
    device/tele2/maxi_lte/rootdir/init.mt6735.usb.rc:root/init.mt6735.usb.rc \
    device/tele2/maxi_lte/rootdir/init.aee.rc:root/init.aee.rc \
    device/tele2/maxi_lte/rootdir/init.project.rc:root/init.project.rc \
    device/tele2/maxi_lte/rootdir/init.modem.rc:root/init.modem.rc \
    device/tele2/maxi_lte/rootdir/init.trace.rc:root/init.trace.rc \
    device/tele2/maxi_lte/rootdir/fstab.mt6735:root/fstab.mt6735 \
    device/tele2/maxi_lte/rootdir/fstab.swap:root/fstab.swap \
    device/tele2/maxi_lte/rootdir/ueventd.rc:root/ueventd.rc \
    device/tele2/maxi_lte/etc/media_codecs.xml:system/etc/media_codecs.xml \
    device/tele2/maxi_lte/etc/init/audioserver.rc:system/etc/init/audioserver.rc \
    device/tele2/maxi_lte/etc/init/mediacodec.rc:system/etc/init/mediacodec.rc \
    device/tele2/maxi_lte/etc/init/cameraserver.rc:system/etc/init/cameraserver.rc \
    device/tele2/maxi_lte/etc/init/rild.rc:system/etc/init/rild.rc \
    device/tele2/maxi_lte/media_profiles.xml:system/etc/media_profiles.xml \
...
PRODUCT_COPY_FILES += \
    device/tele2/maxi_lte/rootdir/etc/hostapd_default.conf:system/etc/hostapd/hostapd_default.conf \
...
# BT A2DP
# PRODUCT_COPY_FILES += \
#    vendor/tele2/maxi_lte/proprietary/vendor/lib/hw/audio.a2dp.blueangel.so:system/vendor/lib/hw/audio.a2dp.mt6735.so
...
#PRODUCT_MODEL := CyaniogenMod on tele2 maxi_lte
...
#persist.sys.tele2.region=cn \
#persist.sys.tele2.codepage=gbk \
#ro.tele2.setupwizard.flyme=true \
#ro.tele2.setupwizard.setlang=true \
#ro.tele2.region.enable=true \
#ro.tele2.contactmsg.auth=false \
#ro.tele2.customize.pccw=false \
#ro.tele2.autorecorder=true \
#ro.tele2.visualvoicemail=true \
#ro.tele2.security=false \
#ro.tele2.permanentkey=false \
#ro.tele2.sip.support=true \
#ro.tele2.voip.support=false \
#sys.tele2.m35x.white.config=false \
#sys.tele2.white.config=false \
